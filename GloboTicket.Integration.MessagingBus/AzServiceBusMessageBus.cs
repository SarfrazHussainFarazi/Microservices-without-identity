...
namespace GloboTicket.Integration.MessagingBus
{
    public class AzServiceBusMessageBus: IMessageBus
    {
        ...
        private string connectionString = "Endpoint=sb://globaltickets.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=zPF1EarpQshteBAA3GdpeQ5h7fbXqhFIxAgA4j7jeII=";
